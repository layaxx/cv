...
\begin{minipage}[t]{0.46\textwidth}
	...
	Softwareenwtickler mit Fokus auf Full-Stack-Webentwicklung (Next.js, Python) und Machine Learning. Erfahrung in der Leitung von IT-Teams, Serveradministration und der Implementierung moderner Softwarelösungen im Unternehmens- und Vereinskontext.
\end{minipage}
...
\begin{entrylist}
	...
	{\vspace{-10pt}
		\begin{itemize}[noitemsep,topsep=1pt,parsep=1pt,partopsep=0pt, leftmargin=-1pt]
			\item \textit{genaue Aufgabenbeschreibung: TBD}
		\end{itemize}}
	\entry
	{9/2024 -- 5/2026}
